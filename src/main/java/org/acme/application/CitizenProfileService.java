...
public class CitizenProfileService {
    ...
    @Transactional
    public IncomeRecord createIncome(IncomeRecord income) {
    ...
    @Transactional
    public CitizenProfile createCitizenProfile(
    ...
    public IncomeRecord getIncome(Long id) {

        return em.find(IncomeRecord.class, id);
    }


    public CitizenProfile getCitizenProfile(Long id) {

        return em.find(CitizenProfile.class, id);
    }
